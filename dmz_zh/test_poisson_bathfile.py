...
def Process_single_image(ref_img_path, tag_img_path, table2):
    ...
    save_dir = 'E:/Coherent-Point-Drift-Python-master/Coherent-Point-Drift-Python-master/dankuang_depth'
    ...
    # output_image_path = os.path.join(save_dir,f"{tag_name}.png")
    # cv2.imwrite(output_image_path, (depth2 *255).astype(np.uint8))
...
if __name__ == '__main__':
    ...
    table = np.load('table_smoothg.npy')

    ref_img_path = 'F:/yxw/dankuang/ref.jpg'  # 参考图片路径
    input_folder = 'F:/yxw/dankuang'  # 包含待处理图片的文件夹
